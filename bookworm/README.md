...
There are many more resources from IBM Watson. 
Check out other services besides Discovery and Conversation in the IBM Cloud: https://console.bluemix.net/catalog/
